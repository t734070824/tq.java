 ...
 */
public class TransactionProxyFactoryBean2App {

    public static void main(String[] args) {
        ApplicationContext context =
                new ClassPathXmlApplicationContext("" +
                        "_5_transaction/_20_spring_transaction_manage/_proxyfactorybean_transactioninterceptor/transactionproxyfactorybean2.xml");
